...
from logistic_tools.core.functions.layout_power.aux_layout_power_func import find_highest_power_node
...
class InspectionPort():
    ...
    :class:`~logistic_tools.classes.OperationsStat.InspectionPortStat.InspectionPortStat`.
    ...
    Attributes:
        ...
        vessel2 (:class:`~logistic_tools.classes.Vessel.Vessel`): Auxiliary
            ...
            defided.
        rov_drone (:class:`~logistic_tools.classes.RovDrone.RovDone`): The ID of the ROV/Drone. 
