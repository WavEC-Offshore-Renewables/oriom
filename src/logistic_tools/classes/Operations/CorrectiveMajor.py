...
class CorrectiveMajor():
    ...
    Attributes:
        ...
        activities (:class:`~logistic_tools.classes.Activity.Activity`): List of
            :class:`~logistic_tools.classes.Activity.Activity` preformed during
        ...
        vessel2 (:class:`~logistic_tools.classes.Vessel.Vessel`): Auxiliary
            vessel used in this operation. Its value is ``None`` if not
            defided.
        failures (:class:`~logistic_tools.classes.Failure.Failure`): List of
            :class:`~logistic_tools.classes.Failure.Failure`.
        rov_drone (:class:`~logistic_tools.classes.RovDrone.RovDone`): Rov/Drone
            used in this operation. Its value is ``None`` if not
            defided.
        ts_data (:class:`~logistic_tools.classes.OperationTimeSeriesData.OperationTimeSeriesData`): 
    ...
    def get_failures(
        ...
        Args:
            failures_list (:class:`~logistic_tools.classes.Failure.Failure`): List of
                :class:`~logistic_tools.classes.Failure.Failure`.
        Raises:
