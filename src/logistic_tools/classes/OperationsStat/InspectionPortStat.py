...
class InspectionPortStat():
    ...
    Attributes:
        ...
        insp_class (:class:`~logistic_tools.classes.Operations.InspectionPort`):
                Inspection at port.
    ...
    def __init__(
        ...
        '''
        Args:
            inspection (:class:`~logistic_tools.classes.Operations.InspectionPort`):
    ...
    def towing_plan(
        ...
        '''
        Args:
            inspection inspection (:class:`~logistic_tools.classes.Operations.InspectionPort`):
                Inspection at port.
            PERCENTILE (:obj:`int`): Percentile for the statistical analysis.
            run_dir (:obj:`str`): Current working folder.
            operations_tow_stat (:obj:`list`): List of statistical operations tow.
        ...
        def get_stats(
            ...
            '''
            Args:
                operation_tow  (:class:`~logistic_tools.classes.OperationStat.OperationTowStat`):
