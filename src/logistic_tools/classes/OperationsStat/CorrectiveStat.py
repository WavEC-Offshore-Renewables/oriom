...
class CorrectiveStat():
    '''CorrectiveStat class.
        ...
        Attributes:
            ...
            op_class (:class:`~logistic_tools.classes.Operations.CorrectiveMinor/Major`):
                Corrective minor or major operation class.
            vessel1 (:class:`~logistic_tools.classes.Vessel.Vessel`): Main vessel
                used in this operation.
            vessel2 (:class:`~logistic_tools.classes.Vessel.Vessel`): Auxiliary vessel
                used in this operation.
    ...
    def __init__(
        ...
        '''
        Args:
            operation (:class:`~logistic_tools.classes.Operations.CorrectiveMinor/Major`): 
    ...
    def get_operation_statistics(
        ...
        Args:
            ...
            operations_tow_stat (:obj:`list`):
                List of :class:`~logistic_tools.classes.OperationTowStat.OperationTowStat`.
        '''
    ...
    def get_corrective_statistics(
        ...
        Args:
            operations (:obj:`list`):
                List of :class:`~logistic_tools.classes.Operations.CorrectiveMinor/Major`
            operations_tow_stat (:obj:`list`):
                list of :class:`~logistic_tools.classes.OperationTowStat.OperationTowStat`
            PERCENTILE (:obj:`int`): Percentile for the statistical analysis.
            run_dur (:obj:`str`): Folder in which there is the statistical analysis.
