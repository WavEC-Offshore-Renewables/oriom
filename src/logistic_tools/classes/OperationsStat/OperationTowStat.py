...
class OperationsTowStat():
    ...
    Attributes:
        ...
        op_class (:class:`~logistic_tools.classes.Operations.OperationTow`):
    ...
    def __init__(
        ...
        '''
        Args:
            operation (:class:`~logistic_tools.classes.Operations.OperationTow`):
                Towing operation class.
    ...
    def get_towing_statistics(
        ...
        Args:
            operations (:obj:`list`):
                list of :class:`~logistic_tools.classes.Operations.OperationTow`.
            PERCENTILE (:obj:`int`): Percentile for the statistical analysis.
            run_dur (:obj:`str`): Folder in which there is the statistical analysis.
        '''
        operations_tow_stat = []
