...
from logistic_tools.core.functions.operation_scheduler.define_shift import output_working_shifts
...
def working_shifts(
    ...
    Args:
        operation (:class:`~logistic_tools.classes.InspectionSite.InspectionSite`): Operation to be studied
        ...
        transit_between_devices (:obj:`float`): Hours for transit between
                devices.
        operation_to_group_with (:class:`~logistic_tools.classes.InspectionSite.InspectionSite`):
            Default to ``None``.
