...
from logistic_tools.utils.aux_functions import convert_stringtime, save_file_csv
...
if __name__ == '__main__':
    ...
    from logistic_tools.timeseries_analysis.timestep_power import add_power_columns
