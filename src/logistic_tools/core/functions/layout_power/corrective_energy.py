...
from logistic_tools.core.functions.layout_power.layout_percentage import return_percentage
from logistic_tools.core.functions.layout_power.pv_power_calculation import calculate_energy_loss_pv
