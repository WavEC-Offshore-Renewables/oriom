...
from logistic_tools.core.functions.operation_scheduler.define_shift import merge_shift_deferred
...
def merge_deferred_operations(        
    ...
    Args:
        ...
        vessels (list): list of class `~logistic_tools.classes.Vessel.Vessel`
