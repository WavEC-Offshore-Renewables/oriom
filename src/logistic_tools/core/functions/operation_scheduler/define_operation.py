...
def define_operation_values(
    ...
    Args:
        ...
        operation: Operation to be analysed. it can be of type:
            :class:`logistic_tools.classes.OperationInspection`,
            :class:`logistic_tools.classes.OperationCorrective` or
            :class:`logistic_tools.classes.OperationTow`.
    ...
    Example:
        ...
        :class:`~logistic_tools.classes.Activity.Activity`.
        >>> df_startability
