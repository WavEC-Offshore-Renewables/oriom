...
def results_block(
    ...
    kpi_total_timeseries, kpi_yearly_timeseries, ctv_dict, daily_vessel, kpi_om_type_cost, df_vessel_fuel_usage = kpi_final_total_cost(
        log_events=log_events,
        log_events_merged=log_events_merged,
        vessels=vessels,
        inputs = inputs,
    ...
    if not df_vessel_fuel_usage.empty:
