...
def kpi_final_total_cost(
    ...
    kpi_om, kpi_om_type_cost, vessel_fuel_usage = kpi_cost_vessel_internal(
    ...
    return kpi_om, kpi_om_year_final, ctv_dict, daily_vessel, kpi_om_type_cost, vessel_fuel_usage
