...
def create_logs_corrective_file(
    ...
    for oper_stat in operation_log_file_stats:
        ...
        if getattr(oper, 'tow_to_port', None):
            ...
            if add_op_tow_site:
                oper_stat_op_site = find_element_class.find_operation_stats_pmax(add_op_tow_site.id)
        ...
        for _, row in failure_filter.iterrows():
            ...
            if tow_op_flag:
                ...
                if add_op_tow_port:
                    tow_stat_chart_month = tow_op_port_stat.dur_total_dict[str(date_failure.month)]
                    ...
                    row_add_op_tow_port, row_mob_line_op_tow_port = create_operation_site(
                        ...
                        oper_ = {
                            'oper': add_op_tow_port, 
                            'oper_stat': oper_stat_op_tow_port, 
                ...
                dates_tow_port = compute_operation_datetimes(
                    ...
                    oper_stat = tow_op_port_stat,
                    add_op_end = end_add_op_time if add_op_tow_port else None,
                ...
                row_tow_port = pd.DataFrame([[
                    ...
                    dates_tow_port['date_end_leadtime'] if not add_op_tow_port else date_failure_tow + timedelta(hours=mob_time),
            ...
            if tow_op_flag:
                ...
                dates_tow_site = compute_operation_datetimes(df_filtered_start_tow, tow_op_site_stat)
                ...
                if add_op_tow_site:
                    tow_stat_chart_month = tow_op_site_stat.dur_total_dict[str(row_tow_site['d_end_leadtime'].iloc[0].month)]
                    ...
                    fail_index = tow_site_oper_sched.index[tow_site_oper_sched['datetime'] == end_tow_site_date][0]
                    ...
                    row_add_op_tow_site, row_mob_line_op_tow_site = create_operation_site(
                        ...
                        oper_ = {
                            'oper': add_op_tow_site,
                            'oper_stat': oper_stat_op_site,
